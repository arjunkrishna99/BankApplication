...
//login
  ...
  // depost api call
  return this.http.post('http://localhost:4200/deposit',data,this.getOptions())
  }
  ...
  withdraw(acno: any, pwd: any, amount: any) {
    ...
    // depost api call
    return this.http.post('http://localhost:4200/withdraw',data,this.getOptions())
  }
  ...
  transaction(acno:any){
    ...
    // depost api call
    return this.http.post('http://localhost:4200/transaction',data,this.getOptions())
  }
    
onDelete(acno:any){
     // ondelete api call
  return this.http.delete('http://localhost:4200/onDelete/'+acno,this.getOptions())
